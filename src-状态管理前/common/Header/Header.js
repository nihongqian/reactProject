...
const Header = (props) => (
  <div className={style["top-header"]}>
    <div className={style.centerflex}>
      ...
      <input type="text" placeholder='连衣裙就是你的女人味儿' style={{"width":"300px","marginLeft":'12px',"border":'0px',"borderRadius":'20px',"fontSize":'15px',"paddingLeft":'50PX',"height":'30px',"marginTop":"7px"}}/>
    </div>
		<NavLink to={'/follow'}>
